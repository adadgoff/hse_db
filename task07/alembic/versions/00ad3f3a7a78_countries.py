...
Revision ID: 00ad3f3a7a78
Revises: 577cdab6393a
Create Date: 2024-11-14 23:27:14.019475
...
revision: str = '00ad3f3a7a78'
down_revision: Union[str, None] = '577cdab6393a'
...
def downgrade() -> None:
    op.execute(sqltext="""
    TRUNCATE public.countries CASCADE;
    """)
